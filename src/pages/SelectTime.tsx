...
export const SelectTime: React.FC = () => {
  ...
  const timeSlots = [
    ...
    { time: '08:30 PM', isBooked: false },
    { time: '09:00 PM', isBooked: true },
    { time: '09:30 PM', isBooked: false },
    { time: '10:00 PM', isBooked: false },
    { time: '10:30 PM', isBooked: false },
    { time: '11:00 PM', isBooked: false },
    { time: '11:30 PM', isBooked: false },
