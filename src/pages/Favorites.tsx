            ...
            return (
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-between min-w-0">
                  ...
                  {/* Chair Status + Book Button */}
                  <div className="mt-4 pt-3 border-t border-gray-100 dark:border-zinc-850 flex items-center justify-between">
                    <div 
                      className="px-2.5 py-1 rounded-xl border text-xs font-extrabold flex items-center gap-1"
                      style={{ borderColor: chairColor, color: chairColor, background: `${chairColor}15` }}
                    >
                      <span>💺</span>
                      <span>{available}/{total} Chairs Available</span>
                    </div>

                    <Button
                      variant="primary"
                      onClick={() => handleOpenShop(shop.shop_id)}
                      className="h-9 px-4 text-xs font-extrabold bg-orange-500 hover:bg-orange-600 text-white rounded-xl shadow-md cursor-pointer flex items-center gap-1.5"
                    >
