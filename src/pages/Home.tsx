        ...
        {selectedShop && (() => {
          ...
          return (
            <motion.div
              ...
              className="absolute bottom-4 left-3 right-3 sm:left-6 sm:right-6 z-20 max-w-xl mx-auto w-[calc(100%-1.5rem)]"
            >
              <div 
                onClick={() => handleOpenDetails(selectedShop.shop_id)}
                className="bg-white dark:bg-zinc-900 rounded-2xl p-2.5 shadow-xl border border-gray-200/80 dark:border-zinc-800 flex flex-row items-center gap-2.5 sm:gap-3 cursor-pointer relative group overflow-hidden"
              >
                {/* 1. Left: Shop Image Thumbnail */}
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden shrink-0 bg-gray-100 dark:bg-zinc-800 relative border border-gray-200/50 dark:border-zinc-800">
                  <img 
                ...
                {/* 2. Center: Shop Info */}
                <div className="flex-1 flex flex-col justify-between min-w-0 h-16 sm:h-20 py-0.5 gap-0.5">
                  ...
                  <div className="flex items-center gap-1.5 min-w-0">
                    ...
                    <span className="inline-flex items-center gap-1 px-1.5 py-0.2 rounded-full bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[8px] font-bold border border-emerald-500/20 shrink-0">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-[9px] sm:text-[10px] text-gray-500 dark:text-zinc-400 font-medium truncate">
                      (128 Reviews)
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-1 text-gray-600 dark:text-zinc-400 min-w-0">
                    ...
                    <span className="text-[9px] sm:text-[10px] truncate font-medium">
                ...
                <div className="flex flex-col justify-between items-end shrink-0 h-16 sm:h-20 gap-0.5 min-w-[110px] sm:min-w-[150px]">
                  {/* Top Right Controls: Distance + Heart + Dismiss */}
                  <div className="flex items-center gap-1 justify-end w-full">
                    <span className="text-[9px] sm:text-[10px] font-extrabold text-gray-800 dark:text-zinc-200 mr-0.5">
                    ...
                    <button
                      ...
                      className={`h-6 w-6 rounded-full border border-gray-200 dark:border-zinc-700 flex items-center justify-center transition-colors cursor-pointer shrink-0 ${
                    ...
                    <button
                      ...
                      className="h-6 w-6 rounded-full border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-400 hover:text-gray-600 dark:hover:text-zinc-200 flex items-center justify-center transition-colors cursor-pointer shrink-0"
                      title="Dismiss"
                    >
                      <X className="h-3 w-3" />
                    </button>
                  ...
                  <button
                    ...
                    className="w-full py-1 sm:py-1.5 px-3 sm:px-4 bg-[#ff0055] hover:bg-[#e0004c] text-white font-extrabold text-[10px] sm:text-[11px] rounded-lg shadow-sm shadow-rose-500/25 transition-all active:scale-95 cursor-pointer text-center whitespace-nowrap"
                  >
                    Book Now
                  </button>
                </div>
