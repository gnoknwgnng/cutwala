...
export const Home: React.FC = () => {
  ...
  return (
    <div className="relative flex-1 flex flex-col h-full w-full bg-[#f3f4f6] dark:bg-zinc-950 overflow-hidden select-none">
      ...
      {/* 2. Single Selected Shop Slide-Up Card matching reference layout */}
      <AnimatePresence>
        {selectedShop && (() => {
          ...
          return (
            ...
            >
              <div 
                ...
                className="bg-white dark:bg-zinc-900 rounded-3xl p-3.5 sm:p-4 shadow-2xl border border-gray-200/80 dark:border-zinc-800 flex flex-row items-center gap-3 sm:gap-4 cursor-pointer relative group overflow-hidden"
              >
                {/* 1. Left: Shop Image Thumbnail */}
                <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden shrink-0 bg-gray-100 dark:bg-zinc-800 relative border border-gray-200/50 dark:border-zinc-800 self-stretch my-auto">
                  <img 
                ...
                {/* 2. Center: Shop Info */}
                <div className="flex-1 flex flex-col justify-center min-w-0 gap-1 my-auto">
                  {/* Shop Title + Live Badge */}
                  <div className="flex items-center gap-1.5 min-w-0">
                    <h3 className="font-display font-extrabold text-sm sm:text-base text-gray-900 dark:text-white truncate tracking-tight">
                      {selectedShop.name}
                    </h3>
                ...
                <div className="flex flex-col justify-between items-end shrink-0 gap-1.5 min-w-[130px] sm:min-w-[170px] my-auto">
                  {/* Top Right Controls: Distance + Heart + Dismiss */}
                  <div className="flex items-center gap-1.5 justify-end w-full">
                    <span className="text-xs font-extrabold text-gray-800 dark:text-zinc-200 mr-0.5">
                  ...
                  <button
                    ...
                    className="w-full py-2 px-4 sm:px-5 bg-[#ff0055] hover:bg-[#e0004c] text-white font-extrabold text-xs rounded-xl shadow-md shadow-rose-500/25 transition-all active:scale-95 cursor-pointer text-center whitespace-nowrap"
                  >
                    Book Now
                  </button>
                </div>
